...
diagrams depicting the above processes are shown in \Cref{fig:higgs_decay}, while
...
In \Cref{table:higgs_branching_ratios} the order is determined by two distinct
...
produce the two final state objects.  \Cref{fig:higgs_decay_plot} shows that
