...
The kinetic terms in \Cref{eq:gsw:gauge_lagrangian} are invariant under
gauge transformations, but simply substituting \Cref{eq:gsw:w_transform} or
\Cref{eq:gsw:b_transform} into the mass terms shows that these terms violate gauge
